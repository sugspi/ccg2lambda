...
plain_dir=/Users/guru/MyResearch/split_and_rephrase/sprp-acl2018/data/baseline-seq2seq-split-RDFs-relations/pre_analysis/head50
fileprefix=test_complex
...
total=0
correct=0
for f in ${plain_dir}/${fileprefix}*.txt; do
  let total++
  base_filename=${f##*/}
